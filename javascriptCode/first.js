...
console.log("My name is rudra vaja");
const UserID = 124578;
...
//var change but its not recognize scop block
...
console.table([UserID,AccountName,AccountPassword,AccountName,CityName,emailid]);//show output in table form with multiple variable
